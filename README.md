  ...
  <div id="app">
    ...
    <div id="content">
      ...
      <div class="step active" id="step1">
        ...
        <p class="text-xl text-gray-700 mb-8">I made something special for you...</p><p>TIP:Aakale me ja kar aage badhe</p>
      ...
      <div class="step" id="step2">
        <div class="emoji">😌</div>
        <h2 class="text-3xl font-bold mb-6 text-gradient">hi...</h2>
        <p class="text-lg text-gray-700 mb-6">mereko tumhe bahot dino se kuch bolna tha and merako itne himmat aa nahi rahi the too mene socha ki type he kar du </p>
        <p>I LIKE YOU💖 </p><br><P>Maybe tumhe aacha na lage mera aasa sound karna too uske liye sorry... </P><button class="btn" id="next-btn-2">CLICK HERE</button>
      </div>

      <!-- Step 3 -->
      <div class="step" id="step3"><p>Again I LIKE YOU💖</p>
        <div class="emoji">🌟</div><H1>Ye lo 🌹</H1><br>
        <p class="text-lg text-gray-700 mb-6">filhal 🌹 iese Rose se kam chalao... (HUM BOHOT DUR RAHATE HAI) </p>
      ...
      <div class="step" id="step4">
        <div class="emoji">💌</div>
        <p class="text-lg text-gray-700 mb-6"> Thanks mujhse itne aache se baat karne ke liye. </p><br>
        <p>Mujhe tum par school time se crush tha And ma school me tumhe  dekh kar humasha bhag jata tha. </p>AND Maine Tumse baat karne ki  kabhi TRY bhi nahi ki😅<p></p>
        <p>Still remember tum 4  standered me hamare class me aaye the with your OG COCKROACH Hairstyle😹.</p><p>
Mai tumhe Rude lag sakta hu but actually me bohot jada shy hu
        </p>
        <p>Waise ek baat batao TUM Mujhe Humasha Dekh kar MUR Kyu jate the???</p><P>THANKS TUMNE YAHA TAK PADHA😇 </P>
        <button class="btn" id="next-btn-4">Click here after reading</button>
      </div>

      <!-- Step 5 -->
      <div class="step" id="step5">
        <div class="emoji">🎊</div>
        <h2 class="text-3xl font-bold text-gradient mb-6">Do you Lke me</h2>
        <button class="btn" id="confetti-btn">YES</button>
        <button class="btn" id="next-btn-5">YES</button>
      </div>

      <!-- Step 6 (Cake) -->
      <div class="step" id="step6">
        <div class="emoji">💝</div>
        <h2 class="text-3xl font-bold text-gradient mb-6">Again Thanks for coming in my life.I will always Remember you</h2>
